...
const HeaderCustom = () => {
  return (
    <div className=" md:h-34  top-0 z-50 flex justify-start bg-black md:w-full">
      <Link className="md:mx-10" href="https://www.wus.agency/" target="_blank">
        <svg
          className="h-44 w-44 fill-fuchsia-50 md:hover:fill-yellow-500"
      ...
      <Link href="https://api.chucknorris.io/" target="_blanc">
        <p className="my-7 mx-2 w-28 font-monospace text-4xl font-bold text-zinc-50 hover:text-yellow-500 md:my-7">
